...
<p align="center">
  <img src="https://raw.githubusercontent.com/self/nautobot-app-my-app/develop/docs/images/icon-my-app.png" class="logo" height="200px">
  <br>
  <a href="https://github.com/self/nautobot-app-my-app/actions"><img src="https://github.com/self/nautobot-app-my-app/actions/workflows/ci.yml/badge.svg?branch=main"></a>
  <a href="https://docs.nautobot.com/projects/my-app/en/latest/"><img src="https://readthedocs.org/projects/nautobot-app-my-app/badge/"></a>
...
> Developer Note: Place the files in the `docs/images/` folder and link them using only full URLs from GitHub, for example: `![Overview](https://raw.githubusercontent.com/self/nautobot-app-my-app/develop/docs/images/app-overview.png)`. This absolute static linking is required to ensure the README renders properly in GitHub, the docs site, and any other external sites like PyPI.
...
![](https://raw.githubusercontent.com/self/nautobot-app-my-app/develop/docs/images/placeholder.png)
...
You can find all the Markdown source for the App documentation under the [`docs`](https://github.com/self/nautobot-app-my-app/tree/develop/docs) folder in this repository. For simple edits, a Markdown capable editor is sufficient: clone the repository and edit away.
